  ...
  return (
    <div className="overflow-auto ">
      <Head>
        ...
        <meta
          property="og:title"
          content="GPT Book Club: Interactive AI-Powered Book Summaries"
        />
        <meta
      ...
      <Header />
      <div className="">
        <HeroText books={books} />
        <div className="mx-5 md:hidden lg:mx-24">
          <div className=" p-1 pb-20 lg:text-left text-center text-6xl font-bold bg-gradient-to-r text-transparent bg-clip-text from-[#7928CA] to-[#FF0080]">
